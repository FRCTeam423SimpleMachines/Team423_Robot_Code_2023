...
public class ScoreHighDrive extends SequentialCommandGroup {
   ...
   */
  public ScoreHighDrive(DriveSubsystem m_DriveSubsystem, ArmSubsystem m_ArmSubsystem, GripperSubsystem m_GripperSubsystem, SwerveControllerCommand smartSwerveController) {
    super(
